#' A Direct Standardization Function Under Logistic Regression
#'
...
#' @export
#' @examples
#' Std_Log_Dir(data,"sex",c("BMI"),Std_by = "white", Group = 1,Ref = "median")

Std_Log_Dir <- function(Data, Outcome, Predictor, Std_by, Group, Ref="median"){
  Data_Var <- names(Data)
