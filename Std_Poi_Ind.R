#' A Indirect Standardization Function Under Poisson Regression
#'
...
#' @export
#' @examples
#' Std_Poi_Ind(data,"sex",c("BMI"),Std_by = "white", Group = 1,Ref = "median")

Std_Poi_Ind <- function(Data, Outcome, Predictor, Std_by, Group, Ref="median"){
  Data_Var <- names(Data)
